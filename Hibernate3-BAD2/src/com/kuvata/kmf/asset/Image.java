...
public class Image extends Asset implements IImage
{
	...
	public static Image create( String assetName, Float length, Displayarea da, Layout l, boolean useFileLocFromServer, 
			String fileLocation, Integer overlayOpacity, Boolean fitToSize, boolean waitForFileUpload, String originalFilename) throws IOException, InterruptedException
	{
	...
	public Image update(String assetName, Float length,
