...
public class Flash extends Asset implements IFlash
{
	...
	public static Flash create(String assetName, Float length, 
			Integer width, Integer height, Displayarea da, Layout l, boolean useFileLocFromServer, String fileLocation, String flashBackgroundColor, Boolean setTransparentBg,
	...
	public Flash update(String assetName, Float length, Integer width, Integer height,
			Displayarea da, Layout l, boolean useFileLocFromServer, String fileLocation, String flashBackgroundColor, Boolean setTransparentBg,
			Integer overlayOpacity, Boolean fitToSize, boolean waitForFileUpload, String originalFilename) throws IOException, InterruptedException
	{
