...
public class SchemaInstance {
	...
	public Session getHibernateSession() throws HibernateException
	{
		...
		if (recordHistory == true)
		{
			...
			if( KmfSession.getKmfSession() != null 
					&& KmfSession.getKmfSession().getAppUsername() != null 
					&& KmfSession.getKmfSession().getAppUsername().length() > 0 ){
				username = KmfSession.getKmfSession().getAppUsername();
			}
	 ...
	 */
	 ...
	 {
		 return KuvataConfig.getKuvataHome() + "/schemas/" + SchemaDirectory.getSchema().getSchemaName() + "/playback_events";
	 }
	 ...
	 {
		 return KuvataConfig.getKuvataHome() + "/schemas/" + SchemaDirectory.getSchema().getSchemaName() + "/uploads";
	 }
	 
	 public String getHwInfoDir()
	 {
		 return KuvataConfig.getKuvataHome() + "/schemas/" + SchemaDirectory.getSchema().getSchemaName() + "/hardware_infos";
	 }
}
