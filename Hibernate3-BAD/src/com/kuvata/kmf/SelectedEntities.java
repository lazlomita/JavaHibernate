...
public class SelectedEntities{
	...
	public static Long createSelectedEntities(String selectedEntityIds, List<Long> allowedIds){
		return createSelectedEntities(KMMServlet.convertCommaDelimitedStringToList(selectedEntityIds), allowedIds);
	}
