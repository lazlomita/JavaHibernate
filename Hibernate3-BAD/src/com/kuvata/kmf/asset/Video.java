...
/*		String videoFilePath = this.getFileloc();
	...
	public static Video create(HttpServletRequest request, HttpServletResponse response, String assetName, Float defaultLength,  Displayarea da, Layout l, boolean useFileLocFromServer, 
			String fileLocation, FormFile formFile, Boolean displayEmbeddedSubtitles, Boolean suppressAudio, Boolean anamorphicWidescreen, Boolean framesync, boolean waitForFileUpload, 
	...
	public void update(HttpServletRequest request, HttpServletResponse response, String assetName, Float defaultLength, Displayarea da, Layout l, boolean useFileLocFromServer, String fileLocation, 
			FormFile formFile, Boolean displayEmbeddedSubtitles, Boolean suppressAudio, Boolean anamorphicWidescreen, Boolean framesync, boolean waitForFileUpload, Integer overlayOpacity, 
			String originalFilename, boolean evaluateDirtyEntity) throws IOException, InterruptedException
	{
		...
		if( useFileLocFromServer == false )
		{
			...
			{				
				...
				// Set the attribute to initiate the upload of the video asset
				setAttributesForUpload( request, this.getAssetId().toString(), this.getAssetName(), fileLocation );					
			}	
		}
