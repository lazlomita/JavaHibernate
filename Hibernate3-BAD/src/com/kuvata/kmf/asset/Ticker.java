...
public class Ticker extends Asset implements ITicker
{
	 ...
	 */
	public static ArrayList getDefaultTickerColors() throws HibernateException
	{
		ArrayList result = new ArrayList();
		result.add( new LabelValueBean("Black", "Black") );
		result.add( new LabelValueBean("Blue", "Blue") );		
		result.add( new LabelValueBean("Red", "Red") );
		result.add( new LabelValueBean("Green", "Green") );
		return result;
	}
	/**
	 * 
	 ...
	 * @throws HibernateException
	 */
	public static ArrayList getDefaultTickerFonts() throws HibernateException
	{
		ArrayList result = new ArrayList();
		result.add( new LabelValueBean(TickerFontType.DEFAULT_FONT.getName(), TickerFontType.DEFAULT_FONT.getPersistentValue()) );
		result.add( new LabelValueBean(TickerFontType.ARIAL.getName(), TickerFontType.ARIAL.getPersistentValue()) );
		result.add( new LabelValueBean(TickerFontType.HELVETICA.getName(), TickerFontType.HELVETICA.getPersistentValue()) );
		result.add( new LabelValueBean(TickerFontType.TAHOMA.getName(), TickerFontType.TAHOMA.getPersistentValue()) );		
		result.add( new LabelValueBean(TickerFontType.VERDANA.getName(), TickerFontType.VERDANA.getPersistentValue()) );
		return result;
	}	
	/**
	 * 
	 ...
	 * @throws HibernateException
	 */
	public static ArrayList getDefaultTickerStyles() throws HibernateException
	{
		ArrayList result = new ArrayList();		
		result.add( new LabelValueBean(TickerStyleType.NORMAL.getName(), TickerStyleType.NORMAL.getPersistentValue()) );
		result.add( new LabelValueBean(TickerStyleType.BOLD.getName(), TickerStyleType.BOLD.getPersistentValue()) );
		result.add( new LabelValueBean(TickerStyleType.ITALIC.getName(), TickerStyleType.ITALIC.getPersistentValue()) );
		return result;
	}		
	 ...
	 * @throws HibernateException
	 */
	public static ArrayList getDefaultTickerBackgroundColors() throws HibernateException
	{
		ArrayList result = new ArrayList();		
		result.add( new LabelValueBean("White", "white") );
		result.add( new LabelValueBean("Black", "black") );		
		return result;
	}			
