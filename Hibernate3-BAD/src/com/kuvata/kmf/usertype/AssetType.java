...
{	
	...
	// This will intentionally not be added to the INSTANCES collection
	public static final AssetType ALL_ASSET_TYPES = new AssetType( Constants.ALL_ASSET_TYPES, Constants.ALL_ASSET_TYPES );	
	...
	public static List<AssetType> getAssetTypes(boolean includeAllAssetTypes, boolean includeControlAssetTypes)
	{
		...
		// If we're including the "All Asset Types"
		if( includeAllAssetTypes ){
			l.add( 0, ALL_ASSET_TYPES );			
		}
